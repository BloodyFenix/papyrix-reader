...
void render(const GfxRenderer& r, const Theme& t, const BootView& v) {
  ...
  r.drawCenteredText(t.uiFontId, pageHeight / 2 + 70, L10N.app_name, t.primaryTextBlack, BOLD);
...
void render(const GfxRenderer& r, const Theme& t, const SleepView& v) {
  ...
  if (v.mode == SleepView::Mode::Logo) {
    ...
    r.drawCenteredText(t.uiFontId, pageHeight / 2 + 70, L10N.app_name, t.primaryTextBlack, BOLD);
    r.drawCenteredText(t.smallFontId, pageHeight / 2 + 110, L10N.sleep_sleeping, t.primaryTextBlack);
